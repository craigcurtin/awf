...
echo "main.py --config_tag fwa --base_record 0  --max_records 10000 --number_of_fetches 5" 
# redirect stdout to /dev/null so we don't count internal i/o in metrics
time python3 main.py  --config_tag fwa --base_record 0  --max_records 10000 	--number_of_fetches 5		1> /dev/null | tee -a ${SAVE_TIME_ITERATION}
